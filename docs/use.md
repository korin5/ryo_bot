...
::: danger
ryo 不能保证转发的曲谱是否准确合法，如果 ryo 转发的曲谱侵犯了你的权益，你可以联系 ryo 的主人凉良（2589984044）进行处理
:::
...
在QQ群里发送 `/找流行的云`，ryo会在自己加入的QQ群的群文件内查找曲谱，找到后返回一个 `[文件]流行的云.pdf`

如果这个文件不是你想要的曲谱，你可以发送 `/找流行的云-2`，让ryo找到第2个 `[文件]流行的云.pdf`

> 文件名会自动忽略大小写，空格，(1) (2) (3) ...
...
如果你想为数据库提供曲谱，做出一份贡献，你可以把文件上传到这个QQ群（870637068）
